export const copy = {
  ...
  hero: {
    title: 'Автоматизируем рутины так, чтобы это приносило деньги, а не просто отчёты',
    subtitle: 'n8n · RAG-чатботы · агенты · интеграции API. Пилот 2–4 недели, понятные метрики, поддержка.',
    slogan: 'Revenue-first automation. Быстро, прагматично, ROI-ориентированно.',
