export const copy = {
  ...
  hero: {
    title: 'Мы создаём ИИ, который работает на ваш бизнес',
    subtitle: 'Разрабатываем автономные AI-агенты и мультиагентные системы. Оптимизируем процессы, сокращаем косты и внедряем реальный ROI.',
    slogan: 'ИИ не захватит мир, если мы ему не поможем.',
    primary_cta: 'Обсудить проект',
    secondary_cta: 'Забронировать звонок',
  },
  services: {
    title: "Услуги",
    items: [
      ...
      {title: "Мультиагентные системы", desc: "Автономные AI-агенты (LangGraph, LangChain). Сложные сценарии, RAG, планирование и исполнение задач."},
      {title: "Чат-боты", desc: "Telegram/WhatsApp/Viber: лидогенерация, саппорт, оплаты."},
      {title: "QA-автотестирование", desc: "AI-генерация тестов, E2E, регресс. Экономия сотен часов ручного тестирования."},
