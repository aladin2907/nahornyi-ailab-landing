export const copy = {
  ...
  hero: {
    ...
    subtitle: 'Від агентів на базі LLM до автономних робочих процесів, ми впроваджуємо передові ШІ-рішення, які оптимізують процеси, скорочують витрати та прискорюють зростання.',
